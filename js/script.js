// 0427eca4c414b359d67048e97e7d4f40
// https://api.themoviedb.org/3/movie/550?api_key=0427eca4c414b359d67048e97e7d4f40
// eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIwNDI3ZWNhNGM0MTRiMzU5ZDY3MDQ4ZTk3ZTdkNGY0MCIsInN1YiI6IjY0NTdhN2NiZmUwNzdhMDE1Njc1ZGYwZCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.AHQ7GHhssvppBiSGhD4-I8Q75eeLECVeC-8mHVUxgAg
...
const global = {
  ...
  api: {
    apiKey: '0427eca4c414b359d67048e97e7d4f40',
...
// displayPoppularMovies
async function displayPoppularMovies() {
...
// displayPoppumarTvShows
async function displayPoppumarTvShows() {
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            <small class="text-muted">${
              global.search.type === 'movie' ? 'Release' : 'First Air Date'
            }: ${
...
// Initialise swiper functionality
function initSwiper() {
...
async function fetchApiData(endPoint) {
  ...
  const API_URL = global.api.apiUrl;
  const res = await fetch(
    `${API_URL}${endPoint}?api_key=${API_KEY}&langauge=en-us`
  );
  const data = await res.json();
  handleSpinner();
  return data;
